...
/**
 * Parses a conventional commit message and infers its impact level.
 *
 ...
 * @returns The inferred impact level
 */
export function inferImpact(message: string): VersionIncrement {
...
/**
 * Processes an array of already inferred commit impacts and returns the maximum impact level.
 *
 * The maximum impact follows the hierarchy: MAJOR > MINOR > PATCH > NONE
 *
 * @param impacts - Array of inferred commit impacts to analyze
